...
public class Vk_Contract {

    public static final String CONTENT_AUTHORITY = "com.example.shepherdxx.c_player";
    public static final String PATH_VK_SAMPLES = "vk_samples";
     ...
     */
    public static class VK_Entry implements BaseColumns {

        public static final Uri CONTENT_URI = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_VK_SAMPLES);

        /**
         * Name of database table for radio_list
         */
        public static final String TABLE_NAME = "vk_music_list";
        ...
        public static boolean isValidValue(int favour) {
            return favour == DEFAULT || favour == YEP || favour == NOPE;
        }
        ...
        public static final String CONTENT_LIST_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_VK_SAMPLES;

        /**
         * The MIME type of the {@link #CONTENT_URI} for a single channel.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_VK_SAMPLES;
    }
