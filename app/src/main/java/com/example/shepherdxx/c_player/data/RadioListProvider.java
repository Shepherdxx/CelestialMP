...
public class RadioListProvider extends ContentProvider {
    ...
    static {
        ...
        // of the pets table.
        sUriMatcher.addURI(DataConstants.CONTENT_AUTHORITY, DataConstants.PATH_RADIO_CHANNELS, RADIO_LIST);
        ...
        sUriMatcher.addURI(DataConstants.CONTENT_AUTHORITY, DataConstants.PATH_RADIO_CHANNELS + "/#", RADIO_CHANEL);
    }
